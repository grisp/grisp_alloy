...
The orchestrator does **not** parse nugget metadata, resolve dependencies, or generate Buildroot configuration. Those tasks belong to smelterl (see [Smelterl Design](02_SMELTERL_DESIGN.md)).
