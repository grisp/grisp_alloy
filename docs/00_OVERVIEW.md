...
- **[Smelterl Design](02_SMELTERL_DESIGN.md)** - Smelterl Erlang application: directory structure, responsibilities, implementation, commands and parameters, build and usage.
...
| **smelterl** | The Erlang tool that plans and generates SDK build targets from nugget metadata (`plan` + target-scoped `generate`). See [Smelterl Design](02_SMELTERL_DESIGN.md). |
...
Variable naming details are in [Data Design](01_DATA_DESIGN.md#environment-variables-and-functions); the full context script content is in [Smelterl Design](02_SMELTERL_DESIGN.md#412-generating-alloy_contextsh).
...
For detailed flows and component responsibilities, see [Smelterl Design](02_SMELTERL_DESIGN.md) and [Alloy Design](03_ALLOY_DESIGN.md).
