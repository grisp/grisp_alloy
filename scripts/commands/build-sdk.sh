...
build_sdk_generate_targets() {
    ...
    log_info "Smelterl generate complete for ${#BUILD_SDK_GENERATED_TARGETS[@]} targets."
}
...
build_sdk_print_summary() {
    ...
    print_hint "Hook wrapper symlinks, Buildroot execution, legal-info, and SDK packing follow in later Phase 5 tasks."
}
